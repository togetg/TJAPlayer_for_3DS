...
void tja_to_notes(int count, sftd_font* font, sf2d_texture *don, sf2d_texture *ka) {
	notes_main(tja_notes,count,tja_title,tja_subtitle,tja_level,tja_bpm,tja_wave,tja_offset,tja_balloon,tja_songvol,tja_sevol,tja_scoreinit,tja_scorediff,tja_course,tja_style,tja_game,tja_life,tja_demostart,tja_side,tja_scoremode,font,don,ka);
}